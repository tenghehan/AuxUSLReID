...
def default_argument_parser():
    ...
    """
    parser = argparse.ArgumentParser(description="UnReID Training")
    parser.add_argument("--config-file", default="configs/USL_MTCluster.yml", metavar="FILE", help="path to config file")
    parser.add_argument(
        "--finetune",
        action="store_true",
